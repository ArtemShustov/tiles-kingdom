...
namespace Game.Tiles.Levels {
	[Obsolete("Use new SerializedLevel instead")]
	public class LegacySerializedLevel: Level {
		...
		#region Editor
		public static LegacySerializedLevel Create(Cell[] cells, Color player) {
			...
			var level = CreateInstance<LegacySerializedLevel>();
